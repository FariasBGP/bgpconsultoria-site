            ...
            <div class="flex justify-between h-20 items-center">
                <div class="flex-shrink-0 flex items-center">
                    <img class="h-10 w-auto" src="MATERIAL/bgp_logomarca_branco.png" alt="BGP Consultoria"
                        onerror="this.src='MATERIAL/logo.jpg'">
                </div>
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#lazaro"
                        class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Lázaro NOS</a>
                    <a href="#solucoes"
                        class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Soluções Core</a>
                    <a href="#autoridade"
                        class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Experiência</a>
                    <a href="#ferramentas"
                        class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Ferramentas
                        Livres</a>
                    <a href="#pricing"
                        class="text-sm font-medium text-slate-300 hover:text-white transition-colors">Planos</a>
                    <a href="#diagnostico"
    ...
    <section id="lazaro" class="py-24 bg-slate-900 border-t border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-slate-400 max-w-3xl mx-auto">Não é apenas monitoramento. O Lázaro é o sistema
            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                <div class="w-full lg:w-5/12 mb-12 lg:mb-0 space-y-8">
                    <img src="MATERIAL/bgp_logomarca_facebook.png" alt="BGP Logotipo"
                        class="h-16 w-auto mb-8 rounded-md bg-white p-2" onerror="this.src='MATERIAL/logo.jpg'">
                ...
                <div
                    ...
                    <div class="flex items-center mb-8">
                        <img src="MATERIAL/FOTO PERFIL.jpg" alt="Farias"
                            ...
                            onerror="this.src='https://ui-avatars.com/api/?name=Farias&background=random'">
                        <div class="ml-6">
    ...
    <footer class="bg-slate-950 border-t border-slate-800 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 text-center md:text-left border-t border-slate-800 pt-8">
                <p class="font-mono text-xs text-slate-600">SYS_STATUS: OPERATIONAL | BGP_SESSIONS: UP | NOC_READY: TRUE
                </p>
            </div>
        </div>
    </footer>
